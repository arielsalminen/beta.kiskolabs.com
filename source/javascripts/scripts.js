...
var docElement = document.documentElement,
  ...
  browserUA = ua.toLowerCase();

// Remove "preload" and "no-js" classes from <html> element
docElement.className = docElement.className.replace(/(^|\s)no-js preload(\s|$)/, 'js ');

// If Meego or winphone
if ((browserUA.search('meego') > -1) || (browserUA.search('windows phone os 7') > -1)) {
  docElement.className = docElement.className + ' support';
}
